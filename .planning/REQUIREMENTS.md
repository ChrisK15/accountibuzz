...
- [x] **SUB-01**: Member can capture and submit a photo (if group is photo-type) before the group's local midnight cutoff
...
| SUB-01 | Phase 3 — Capture & Admin Review | Complete |
