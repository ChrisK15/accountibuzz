...
- **D-05: TUS resumable upload + offline queue, both photo and video.** Unified pipeline. Research-phase **must** validate the supabase-js 2.58 + Expo SDK 55 + TUS reference implementation before locking the exact client (this was already flagged in `.planning/STATE.md` as the Phase 3 research item).
