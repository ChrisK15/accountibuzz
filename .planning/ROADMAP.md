...
- [x] 04-03-PLAN.md — Data layer: 7 hooks; useGroupTombstones returns locked shape { pendingToday, missedYesterday, isPending, error }; useGroupFeedRealtime uses MVP invalidation (HIGH #8); useGroupLeaderboardRealtime sorts by joined_at ASC tiebreaker
